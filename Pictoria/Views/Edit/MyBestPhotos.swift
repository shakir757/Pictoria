    ...
    var body: some View {
        ScrollView(.vertical) {
            if !images.isEmpty && !isLoading {
                ...
                VStack {
                    Text("This is where your best photos will be. Start editing...")
                        .frame(maxWidth: .infinity, alignment: .center)
        ...
        .padding(.horizontal, 16)
        .navigationTitle("My Best Photos")
        .navigationBarTitleDisplayMode(.large)
        .onAppear {

            if let imageDataArray = UserDefaults.standard.array(forKey: "BestPhoto") as? [Data] {
